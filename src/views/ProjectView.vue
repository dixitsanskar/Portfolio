...
<template>
   <div class="relative flex flex-row justify-items-center align-middle mt-10  text-left font-inter text-black">
      <div class=" flex flex-row">
        ...
        <div class="relative text-[58px] mt-3 leading-[70px] text-white">
          <p class="m-0">
            <span class="font-semibold">My Creative Works
              </span>
          </p>
          <p class="m-0">
            <span class="tracking-[-0.01em]">
              <b>Latest</b>
              <span class="font-inter text-[#ffd330] font-semibold"> Project?</span>
            </span>
          </p>
        </div>
        <div class="relative mt-6 leading-[150%] text-white inline-block w-[540px]">
          <p class="m-0">I have selected and mentioned here some of </p>
          <p class="m-0">my latest projects to share with you.</p>
        </div>
        <div class="relative mt-10  w-[138px] h-[56px] text-center">
          <a class="!justify-start hover:no-underline" href=""><div class="font-semibold bg-[#ffd330] rounded-[12px] px-4 py-3 leading-[150%]">Show More</div></a>
        </div>
        </div>
